...
# Write a program that checks whether the vehicle registration number entered from the 
# keyboard means a vehicle from Krakow. Print True whether a car is from Krakow or 
# False otherwise. Sample result:
