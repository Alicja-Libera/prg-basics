# In every programming language there is a function to take input from the user. 
# The function allows the program to pause and wait for the user to type something on the keyboard. 
