# Take into account that whatever the user types on the keyboard is captured as a string. 
# If you need a number for some arithmetic calculations, 
# you have to convert the string of digits from the keyboard to a number using the int() 
# function for integer numbers and float() function for real numbers.
